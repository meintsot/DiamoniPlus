...
public class RentalSpacesForExportType {
    ...
    private List<ImageFileType> rentalImages = new ArrayList<>();
    ...
    public List<ImageFileType> getRentalImages() {
        return rentalImages;
    }

    public void setRentalImages(List<ImageFileType> rentalImages) {
